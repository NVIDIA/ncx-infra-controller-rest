...
- **Add user-defined task schedules** ([#392](https://github.com/NVIDIA/infra-controller-rest/pull/392))
...
- **Add support for Delta PMC vendor in Powershelf Manager** ([#331](https://github.com/NVIDIA/infra-controller-rest/pull/331))
...
- **Support explicit rule ID override in RLA sequence requests** ([#404](https://github.com/NVIDIA/infra-controller-rest/pull/404))
...
- **Reject DB connection when no encryption** ([#428](https://github.com/NVIDIA/infra-controller-rest/pull/428))
...
- **Add Site Agent manager for VPC Peering and fix workflows** ([#424](https://github.com/NVIDIA/infra-controller-rest/pull/424))
...
- **Send protocolVersion and routingType on IP block create** ([#412](https://github.com/NVIDIA/infra-controller-rest/pull/412))
...
- **Update SSH Key Group status after successful sync to Site** ([#411](https://github.com/NVIDIA/infra-controller-rest/pull/411))
...
- **Prevent duplicate --data flag panic on carbidecli create commands** ([#401](https://github.com/NVIDIA/infra-controller-rest/pull/401))
...
- **Resolve required query param for tenant-account list in TUI** ([#408](https://github.com/NVIDIA/infra-controller-rest/pull/408))
  Fixes the TUI tenant-account list command that was failing due to a missing required query parameter.

- **Error when flags are placed after a positional argument in carbidecli** ([#400](https://github.com/NVIDIA/infra-controller-rest/pull/400))
...
- **Fix OpenAPI URL for IP Block, SSH Key/Group and Tenant Account in TUI/CLI** ([#397](https://github.com/NVIDIA/infra-controller-rest/pull/397))
...
- **Include IP block flag in VPC prefix create log** ([#426](https://github.com/NVIDIA/infra-controller-rest/pull/426))
  Updates the CLI hint text for VPC Prefix creation to include the required IP Block flag.

### Refactoring

- **Create generic Execute interface and workflow/activity registries in RLA** ([#419](https://github.com/NVIDIA/infra-controller-rest/pull/419))
...
- **Reduce tests duration by up to 36%** ([#431](https://github.com/NVIDIA/infra-controller-rest/pull/431))
...
- **Add Grype container vulnerability scan to build-push-service** ([#418](https://github.com/NVIDIA/infra-controller-rest/pull/418))
...
- **Add GitHub workflow to ensure Core protobuf is up to date** ([#391](https://github.com/NVIDIA/infra-controller-rest/pull/391))
...
- **Clean up deprecated workflows/activities in Site Agent** ([#375](https://github.com/NVIDIA/infra-controller-rest/pull/375))
...
- **Switch from deprecated attributes for VPC Prefix create/update request to Site** ([#423](https://github.com/NVIDIA/infra-controller-rest/pull/423))
  Migrates VPC Prefix create and update API handlers from deprecated Core proto attributes to their current replacements.

- **Add back standard SDK module after repo rename** ([#265](https://github.com/NVIDIA/infra-controller-rest/pull/265))
...
- **Configure NSM and PSM to run in-memory mode by default** ([#410](https://github.com/NVIDIA/infra-controller-rest/pull/410))
...
- **Update Instance creation API test, validate unhealthy Machine flag sent to Core** ([#407](https://github.com/NVIDIA/infra-controller-rest/pull/407))
  Strengthens Instance creation tests to verify the `allowUnhealthyMachine` flag is correctly forwarded to Core.

- **Fix idempotency issue for warning comments in Core proto format script** ([#389](https://github.com/NVIDIA/infra-controller-rest/pull/389))
  Makes `make core-proto-fmt` fully idempotent by preventing duplicate warning comment and block insertion on repeated runs.

- **Re-generate Core protobuf to align with latest proto files** ([#390](https://github.com/NVIDIA/infra-controller-rest/pull/390))
...
- **Add support for updating InfiniBand Partition data on Site** ([#334](https://github.com/NVIDIA/infra-controller-rest/pull/334))
...
- **Add net.HardwareAddr wrapper for BMC MAC JSON marshaling** ([#369](https://github.com/NVIDIA/infra-controller-rest/pull/369))
...
- **Include name in update request of NVLink Partition Update** ([#373](https://github.com/NVIDIA/infra-controller-rest/pull/373))
...
- **Require TLS certs by default for RLA/PSM/NVSM and IPAM server** ([#333](https://github.com/NVIDIA/infra-controller-rest/pull/333))
...
- **Update default firmware update sequence for NSM to only include BMC and BIOS updates** ([#376](https://github.com/NVIDIA/infra-controller-rest/pull/376))
...
- **Prepare for Machine/InstanceType Association ID deprecation** ([#367](https://github.com/NVIDIA/infra-controller-rest/pull/367))
...
- **Include NVLink and InfiniBand Interfaces while cleaning up Instance resources** ([#366](https://github.com/NVIDIA/infra-controller-rest/pull/366))
...
- **Harden scheduler dispatcher correctness and unit tests of RLA** ([#364](https://github.com/NVIDIA/infra-controller-rest/pull/364))
...
- **Added status field in NVLink Interface summary API model** ([#363](https://github.com/NVIDIA/infra-controller-rest/pull/363))
...
- **Fix bringup sequence, NSM stale records, and unify tray/rack type enums** ([#377](https://github.com/NVIDIA/infra-controller-rest/pull/377))
...
- **Add dev mode for RLA service** ([#360](https://github.com/NVIDIA/infra-controller-rest/pull/360))
...
- **Skip config filter in DB if no config query params are set when retrieving all Sites** ([#379](https://github.com/NVIDIA/infra-controller-rest/pull/379))
...
- **Maintain association record when Instance Type is updated in Machine inventory** ([#383](https://github.com/NVIDIA/infra-controller-rest/pull/383))
...
- **Have PSM read firmware files at startup time rather than using an embedded filesystem** ([#385](https://github.com/NVIDIA/infra-controller-rest/pull/385))
...
- **Require Ready status for targeted machine instance creation** ([#357](https://github.com/NVIDIA/infra-controller-rest/pull/357))
...
- **Replace hardcoded API name in path in TUI using helper** ([#356](https://github.com/NVIDIA/infra-controller-rest/pull/356))
...
- **Rename Site Agent and mock Core/RLA server binary** ([#365](https://github.com/NVIDIA/infra-controller-rest/pull/365))
...
- **Update Core proto and improve firmware update sequencing in RLA** ([#361](https://github.com/NVIDIA/infra-controller-rest/pull/361))
...
- **Update Core proto snapshot for REST components** ([#251](https://github.com/NVIDIA/infra-controller-rest/pull/251))
...
- **Add changelog with detailed history of released tags up to v1.2.1** ([#359](https://github.com/NVIDIA/infra-controller-rest/pull/359))
...
- **Allow Instance Interfaces to span multiple VPCs** ([#300](https://github.com/NVIDIA/infra-controller-rest/pull/300))
...
- **Infer Tenant/Provider context from org when retrieving Allocation/Instance Type** ([#217](https://github.com/NVIDIA/infra-controller-rest/pull/217))
...
- **Modify NSM and PSM Vault credential format to match NICo's standard pattern** ([#341](https://github.com/NVIDIA/infra-controller-rest/pull/341))
...
- **Revise PatchComponent, add DeleteRack, PurgeRack, PurgeComponent gRPC APIs in RLA** ([#320](https://github.com/NVIDIA/infra-controller-rest/pull/320))
...
- **Add Tenant Account search query and fix tsquery parsing** ([#315](https://github.com/NVIDIA/infra-controller-rest/pull/315))
...
- **Aggregate NVSwitch sub-component firmware statuses in Carbide path in RLA** ([#355](https://github.com/NVIDIA/infra-controller-rest/pull/355))
...
- **Prevent UpdateTaskStatus from overwriting started_at with NULL in RLA task executor** ([#354](https://github.com/NVIDIA/infra-controller-rest/pull/354))
...
- **Align PMC Vault path with Core/NSM** ([#353](https://github.com/NVIDIA/infra-controller-rest/pull/353))
...
- **Correct child workflow timeout/error and improve compute firmware update lifecycle in RLA** ([#348](https://github.com/NVIDIA/infra-controller-rest/pull/348))
...
- **Make PSM registration credentials-optional and idempotent** ([#347](https://github.com/NVIDIA/infra-controller-rest/pull/347))
...
- **Only report inherited VPC propagation when interfaces are attached** ([#342](https://github.com/NVIDIA/infra-controller-rest/pull/342))
...
- **Prevent modification of virtualization type for VPCs with Subnets or Instances** ([#343](https://github.com/NVIDIA/infra-controller-rest/pull/343))
...
- **Normalize MAC address case in NSM/PSM vault credential lookups** ([#345](https://github.com/NVIDIA/infra-controller-rest/pull/345))
...
- **Auto-migrate NSM database schema on startup** ([#340](https://github.com/NVIDIA/infra-controller-rest/pull/340))
...
- **Add health-report override and idempotent power-option handling in RLA** ([#335](https://github.com/NVIDIA/infra-controller-rest/pull/335))
...
- **Add 10 MiB request body size limit to prevent OOM** ([#330](https://github.com/NVIDIA/infra-controller-rest/pull/330))
...
- **Infer Provider and Tenant ID from org association when creating Operating Systems** ([#344](https://github.com/NVIDIA/infra-controller-rest/pull/344))
...
- **Add HTTP read/write/idle timeout in Echo config** ([#339](https://github.com/NVIDIA/infra-controller-rest/pull/339))
...
- **Add detailed review config for CodeRabbit** ([#337](https://github.com/NVIDIA/infra-controller-rest/pull/337))
  Updates CodeRabbit configuration to provide more contextual and well-informed automated code reviews.

- **Add codeowners file to repository** ([#295](https://github.com/NVIDIA/infra-controller-rest/pull/295))
  Introduces a CODEOWNERS file so reviewers are automatically assigned to pull requests based on file ownership.

- **Optimize NVLink Logical Partition lookup in Instance update API handler** ([#332](https://github.com/NVIDIA/infra-controller-rest/pull/332))
...
- **Add full CRUD parity for TUI interactive mode** ([#305](https://github.com/NVIDIA/infra-controller-rest/pull/305))
...
- **Add label display, filtering, and sorting to TUI** ([#306](https://github.com/NVIDIA/infra-controller-rest/pull/306))
...
- **Add interactive instance create/delete and keybinding help** ([#294](https://github.com/NVIDIA/infra-controller-rest/pull/294))
...
- **Add configurable API name support to SDK REST clients** ([#322](https://github.com/NVIDIA/infra-controller-rest/pull/322))
...
- **Update RLA inventory sync to use Core for switch and powershelf management** ([#321](https://github.com/NVIDIA/infra-controller-rest/pull/321))
...
- **Add DPU extension observability config options** ([#291](https://github.com/NVIDIA/infra-controller-rest/pull/291))
...
- **Dual-write Expected Inventory REST APIs into Core and RLA** ([#303](https://github.com/NVIDIA/infra-controller-rest/pull/303))
...
- **Add pagination fallback in RLA gRPC** ([#318](https://github.com/NVIDIA/infra-controller-rest/pull/318))
...
- **Trigger power-off via task manager on leak detection** ([#308](https://github.com/NVIDIA/infra-controller-rest/pull/308))
...
- **Add NVLink Switch inventory sync with NSM registration and drift detection** ([#298](https://github.com/NVIDIA/infra-controller-rest/pull/298))
...
- **Add REST API models and endpoints for VPC peering** ([#257](https://github.com/NVIDIA/infra-controller-rest/pull/257))
...
- **Initial implementation of tray leak detection** ([#297](https://github.com/NVIDIA/infra-controller-rest/pull/297))
...
- **Add mTLS support to RLA CLI and refactor cert packages** ([#299](https://github.com/NVIDIA/infra-controller-rest/pull/299))
...
- **Add AGENTS.md info file for repo** ([#292](https://github.com/NVIDIA/infra-controller-rest/pull/292))
...
- **Support task conflict detection on component-level** ([#278](https://github.com/NVIDIA/infra-controller-rest/pull/278))
...
- **Add API model and endpoint for retrieving RLA Tasks** ([#252](https://github.com/NVIDIA/infra-controller-rest/pull/252))
...
- **Support firmware upgrades in-memory mode for PSM** ([#277](https://github.com/NVIDIA/infra-controller-rest/pull/277))
...
- **Implement Carbide provider for NVLSwitch and PowerShelf component managers** ([#256](https://github.com/NVIDIA/infra-controller-rest/pull/256))
...
- **Refactor task workflow and component manager in RLA** ([#269](https://github.com/NVIDIA/infra-controller-rest/pull/269))
...
- **Add Site-Agent bootstrap hook support in helm chart** ([#263](https://github.com/NVIDIA/infra-controller-rest/pull/263))
...
- **Allow explicit IP selection when creating/updating instances** ([#271](https://github.com/NVIDIA/infra-controller-rest/pull/271))
...
- **Populate APIError source attribute from API name** ([#287](https://github.com/NVIDIA/infra-controller-rest/pull/287))
...
- **Strip leading comma from Docker image tags in CI** ([#323](https://github.com/NVIDIA/infra-controller-rest/pull/323))
...
- **Load RLA Temporal client certificates using cert module** ([#319](https://github.com/NVIDIA/infra-controller-rest/pull/319))
...
- **Support clearing NVLink Logical Partition ID in VPC update** ([#284](https://github.com/NVIDIA/infra-controller-rest/pull/284))
...
- **Fixed legacy RLA and PSM makefiles VERSIONS usage and removed obsolete dockerfiles** ([#286](https://github.com/NVIDIA/infra-controller-rest/pull/286))
...
- **Reset IsUsableByTenant when machine goes missing on Site** ([#317](https://github.com/NVIDIA/infra-controller-rest/pull/317))
...
- **Return all trays when rackId/rackName not specified in GET /tray** ([#312](https://github.com/NVIDIA/infra-controller-rest/pull/312))
...
- **Defaulted native_networking and network_security_group to true** ([#309](https://github.com/NVIDIA/infra-controller-rest/pull/309))
...
- **Delete NVLink interfaces when Site reports config as synced** ([#267](https://github.com/NVIDIA/infra-controller-rest/pull/267))
...
- **Prevent VPC Prefix deletion when Instance Interfaces are present** ([#285](https://github.com/NVIDIA/infra-controller-rest/pull/285))
  Blocks deletion of VPC prefixes that have active Instance Interfaces using them, preventing orphaned network references.

- **Enable NVLink deviceType specification in Instance Type update** ([#283](https://github.com/NVIDIA/infra-controller-rest/pull/283))
...
- **Permit NVLink deviceType on GPU capabilities for instance type** ([#280](https://github.com/NVIDIA/infra-controller-rest/pull/280))
...
- **Empty array must be passed to underlying SDK when caller specifies one** ([#275](https://github.com/NVIDIA/infra-controller-rest/pull/275))
...
- **Exclude ingestion from default bringup sequence rule** ([#311](https://github.com/NVIDIA/infra-controller-rest/pull/311))
...
- **Fix routing type enum in IP Block create request schema** ([#313](https://github.com/NVIDIA/infra-controller-rest/pull/313))
  Corrects an extraneous space in the routing type enum value within the OpenAPI schema for IP Block creation requests.

### CI/CD

- **Remove trivy scan job** ([#307](https://github.com/NVIDIA/infra-controller-rest/pull/307))
  Removes the Trivy container vulnerability scanning job from the CI pipeline.

### Chores

- **Remove email from OpenAPI specs and auto-generated files** ([#302](https://github.com/NVIDIA/infra-controller-rest/pull/302))
  Strips personal email addresses from the OpenAPI specification and all associated auto-generated files.

- **Move common and cert-manager to subchart** ([#290](https://github.com/NVIDIA/infra-controller-rest/pull/290))
...
- **Update issue templates to standardize and remove duplicates** ([#288](https://github.com/NVIDIA/infra-controller-rest/pull/288))
...
- **Allow different Logical Partitions for NVLink Interfaces on Instance creation/update** ([#225](https://github.com/NVIDIA/infra-controller-rest/pull/225))
...
- **Add optional DB secret volume mount in Helm Chart** ([#260](https://github.com/NVIDIA/infra-controller-rest/pull/260))
...
- **Add task conflict detection and queue framework** ([#233](https://github.com/NVIDIA/infra-controller-rest/pull/233))
...
- **Add total assigned Machines to Instance Type allocation stats** ([#245](https://github.com/NVIDIA/infra-controller-rest/pull/245))
...
- **Standardize API enum formatting and extend Tray response fields** ([#241](https://github.com/NVIDIA/infra-controller-rest/pull/241))
...
- **Allow filtering Machines by whether missing on site** ([#243](https://github.com/NVIDIA/infra-controller-rest/pull/243))
...
- **Add REST endpoints for ExpectedPowerShelf and ExpectedSwitch** ([#220](https://github.com/NVIDIA/infra-controller-rest/pull/220))
...
- **Add API endpoints for RLA rack bring up** ([#206](https://github.com/NVIDIA/infra-controller-rest/pull/206))
...
- **Port NV-Switch manager into the repository** ([#192](https://github.com/NVIDIA/infra-controller-rest/pull/192))
...
- **Add stale issue or PR check workflow** ([#221](https://github.com/NVIDIA/infra-controller-rest/pull/221))
...
- **Add simple Go SDK focused on easier Instance creation** ([#177](https://github.com/NVIDIA/infra-controller-rest/pull/177))
...
- **Added API endpoints for listing InfiniBand and NVLink Interfaces across Instances** ([#218](https://github.com/NVIDIA/infra-controller-rest/pull/218))
...
- **Invalidate all scope-filtered resource types on scope change in CLI** ([#249](https://github.com/NVIDIA/infra-controller-rest/pull/249))
...
- **Include scope args in CLI interactive mode command printout** ([#248](https://github.com/NVIDIA/infra-controller-rest/pull/248))
...
- **Add mock methods for ExpectedPowerShelf and ExpectedSwitch to ForgeTest** ([#239](https://github.com/NVIDIA/infra-controller-rest/pull/239))
  Adds the missing mock implementations needed for testing ExpectedPowerShelf and ExpectedSwitch handlers.

- **Unwrap full Temporal error chain in UnwrapWorkflowError** ([#240](https://github.com/NVIDIA/infra-controller-rest/pull/240))
...
- **Use proto field getters in Site workflow logs to prevent nil panics** ([#238](https://github.com/NVIDIA/infra-controller-rest/pull/238))
...
- **Omit terminating DPU Extension Service deployments in update request to Site** ([#219](https://github.com/NVIDIA/infra-controller-rest/pull/219))
...
- **Handle nil gRPC client in Site Agent workflows** ([#235](https://github.com/NVIDIA/infra-controller-rest/pull/235))
  Adds nil checks for the RLA gRPC client in Site Agent workflows, preventing panics when the RLA integration is disabled.

- **Correct NSM binary path in Dockerfile for CI extraction** ([#234](https://github.com/NVIDIA/infra-controller-rest/pull/234))
...
- **Rename Bare Metal Manager module/references to NVIDIA Infra Controller** ([#262](https://github.com/NVIDIA/infra-controller-rest/pull/262))
  Updates the Go module path and all documentation references from "Bare Metal Manager" to "NVIDIA Infra Controller", reflecting the project's official naming.

- **Update Carbide proto in RLA and refactor RLA inventory loop sync** ([#253](https://github.com/NVIDIA/infra-controller-rest/pull/253))
...
- **Rename ExpectedPowerShelf and ExpectedSwitch IDs** ([#258](https://github.com/NVIDIA/infra-controller-rest/pull/258))
...
- **Pass a JSON-safe struct to executor instead of domain Rack** ([#236](https://github.com/NVIDIA/infra-controller-rest/pull/236))
...
- **Adopt the common.SetupHandler for more handlers** ([#231](https://github.com/NVIDIA/infra-controller-rest/pull/231))
...
- **Consolidate duplicated database access and Temporal config code** ([#193](https://github.com/NVIDIA/infra-controller-rest/pull/193))
...
- **Create wrapped errors instead of formatted ones** ([#229](https://github.com/NVIDIA/infra-controller-rest/pull/229))
...
- **Clean up duplicate package imports** ([#227](https://github.com/NVIDIA/infra-controller-rest/pull/227))
  Removes redundant package import aliases and consolidates inconsistent import styles across the codebase.

- **Rename legacy cloud-api references to carbide-rest-api** ([#226](https://github.com/NVIDIA/infra-controller-rest/pull/226))
...
- **Add deployment guide based on latest kustomization logic** ([#228](https://github.com/NVIDIA/infra-controller-rest/pull/228))
...
- **Add site machineStats to schema** ([#244](https://github.com/NVIDIA/infra-controller-rest/pull/244))
...
- **Update auth documentation to match latest deployment manifests** ([#224](https://github.com/NVIDIA/infra-controller-rest/pull/224))
  Revises authentication documentation to accurately reflect the current Keycloak deployment configuration and auth flow.

### CI/CD

- **Update CodeRabbit config to prevent PR description update, reduce noise** ([#255](https://github.com/NVIDIA/infra-controller-rest/pull/255))
...
- **Enable CodeRabbit PR review** ([#250](https://github.com/NVIDIA/infra-controller-rest/pull/250))
  Enables CodeRabbit.ai for automated code reviews on submitted pull requests, replacing intermittent Copilot functionality.

- **Upgrade Trivy action version** ([#222](https://github.com/NVIDIA/infra-controller-rest/pull/222))
  Updates the Trivy security scanning action to the latest version for improved vulnerability detection.

- **Fix Trivy update comment logic** ([#210](https://github.com/NVIDIA/infra-controller-rest/pull/210))
  Corrects the logic for updating Trivy scan results in PR comments to prevent duplicate comment creation.

### Chores

- **Support helm deploy on KinD in makefile** ([#232](https://github.com/NVIDIA/infra-controller-rest/pull/232))
  Adds Makefile targets for deploying the Helm chart to a local KinD cluster, streamlining the local development workflow.

- **Improved handling of a few swallowed errors** ([#230](https://github.com/NVIDIA/infra-controller-rest/pull/230))
  Surfaces several previously swallowed errors in handler and workflow code, improving observability of failure conditions.

- **Rename site-agent chart deployment to statefulset** ([#208](https://github.com/NVIDIA/infra-controller-rest/pull/208))
...
- **Disable Image-based OS for Instance creation/update** ([#176](https://github.com/NVIDIA/infra-controller-rest/pull/176))
...
- **Add rla rack create CLI command and examples directory** ([#191](https://github.com/NVIDIA/infra-controller-rest/pull/191))
...
- **Add RLA IngestRack API for injecting expected components** ([#189](https://github.com/NVIDIA/infra-controller-rest/pull/189))
...
- **Add NVSwitch Manager plugin for RLA** ([#172](https://github.com/NVIDIA/infra-controller-rest/pull/172))
  Adds NVSwitch Manager as a new backend for managing NVLink Switch components within the Rack Level Administration system.

- **Add Go sub-module for SDK at sdk/standard/** ([#187](https://github.com/NVIDIA/infra-controller-rest/pull/187))
...
- **Added support for explicit VPC ID and VNI** ([#166](https://github.com/NVIDIA/infra-controller-rest/pull/166))
...
- **Add bmmcli TUI interactive mode with config selector** ([#165](https://github.com/NVIDIA/infra-controller-rest/pull/165))
...
- **UpdateInstance API: Preserve DPU extension fields if unset** ([#214](https://github.com/NVIDIA/infra-controller-rest/pull/214))
...
- **Set NVLinkPartition status based on response from Site** ([#134](https://github.com/NVIDIA/infra-controller-rest/pull/134))
...
- **Updated stats pagination limit, maxAllocatable formula, and decommissioned machine handling** ([#195](https://github.com/NVIDIA/infra-controller-rest/pull/195))
...
- **Allow longer prefix length for VPC prefixes** ([#179](https://github.com/NVIDIA/infra-controller-rest/pull/179))
...
- **Added missing entries for RLA and PSM in build-push-docker.yaml** ([#181](https://github.com/NVIDIA/infra-controller-rest/pull/181))
  Adds the missing Docker build and push entries for RLA and PowerShelf Manager in the CI workflow configuration.

### Refactoring

- **Refactor Firmware and BringUp workflows to rule-based execution** ([#190](https://github.com/NVIDIA/infra-controller-rest/pull/190))
...
- **Correct schemas for Rack/Tray endpoint response examples in OpenAPI spec** ([#196](https://github.com/NVIDIA/infra-controller-rest/pull/196))
...
- **Update style check workflow to error on `go fmt` failure** ([#194](https://github.com/NVIDIA/infra-controller-rest/pull/194))
...
- **Move dynamic TLS handler to common package** ([#207](https://github.com/NVIDIA/infra-controller-rest/pull/207))
...
- **Add pull request template** ([#205](https://github.com/NVIDIA/infra-controller-rest/pull/205))
...
- **Remove DB references from Site Agent** ([#203](https://github.com/NVIDIA/infra-controller-rest/pull/203))
...
- **rename bmmcli to carbidecli** ([#188](https://github.com/NVIDIA/infra-controller-rest/pull/188))
...
- **Add bare metal manager rest helm chart** ([#186](https://github.com/NVIDIA/infra-controller-rest/pull/186))
...
- **Update publish chart jobs** ([#199](https://github.com/NVIDIA/infra-controller-rest/pull/199))
  Updates CI jobs for Helm chart publishing with revised configurations.

- **Update helm jobs to workflow** ([#198](https://github.com/NVIDIA/infra-controller-rest/pull/198))
  Migrates Helm deployment jobs to reusable GitHub Actions workflows for better maintainability.

- **Add back kustomization per-components** ([#148](https://github.com/NVIDIA/infra-controller-rest/pull/148))
...
## [v1.0.5](https://github.com/NVIDIA/infra-controller-rest/releases/tag/v1.0.5) — 2026-03-02

### Features

- **Allow filtering Machines by the presence of associated Instance** ([#180](https://github.com/NVIDIA/infra-controller-rest/pull/180))
...
- **Handle duplicate key error on SSH Key Group creation by switching to sync workflow** ([#113](https://github.com/NVIDIA/infra-controller-rest/pull/113))
...
- **Allow providers to filter Machines by Tenant IDs** ([#168](https://github.com/NVIDIA/infra-controller-rest/pull/168))
...
- **Add RLA rule engine logic** ([#167](https://github.com/NVIDIA/infra-controller-rest/pull/167))
...
- **Add Powershelf Manager service as a component** ([#161](https://github.com/NVIDIA/infra-controller-rest/pull/161))
...
- **Add Rack Level Administration site config flag to gate RLA endpoints** ([#162](https://github.com/NVIDIA/infra-controller-rest/pull/162))
...
- **Add API endpoints for RLA power control and firmware update** ([#157](https://github.com/NVIDIA/infra-controller-rest/pull/157))
...
- **Add site-level stats endpoints for GPU, instance type, and tenant allocation** ([#137](https://github.com/NVIDIA/infra-controller-rest/pull/137))
...
- **Add bmmcli — OpenAPI-driven CLI for Bare Metal Manager REST API** ([#160](https://github.com/NVIDIA/infra-controller-rest/pull/160))
...
- **Add Tray validation REST API endpoints** ([#156](https://github.com/NVIDIA/infra-controller-rest/pull/156))
...
- **Add unknown query parameter validation for handlers** ([#149](https://github.com/NVIDIA/infra-controller-rest/pull/149))
...
- **Add API models and endpoints for Tray management** ([#128](https://github.com/NVIDIA/infra-controller-rest/pull/128))
...
- **Add rack validate REST API endpoints** ([#122](https://github.com/NVIDIA/infra-controller-rest/pull/122))
...
- **Add labels support in InstanceType** ([#102](https://github.com/NVIDIA/infra-controller-rest/pull/102))
...
- **Relocate RLA code to bare-metal-manager-rest** ([#119](https://github.com/NVIDIA/infra-controller-rest/pull/119))
...
- **Add generated Golang client for OpenAPI spec** ([#129](https://github.com/NVIDIA/infra-controller-rest/pull/129))
...
- **Aligned InfiniBand Partition proto snapshot with Core** ([#164](https://github.com/NVIDIA/infra-controller-rest/pull/164))
...
- **Unify machine status breakdown into single reusable type** ([#171](https://github.com/NVIDIA/infra-controller-rest/pull/171))
...
- **Replace forge with Carbide in Expected Machine/Audit API route prefix** ([#158](https://github.com/NVIDIA/infra-controller-rest/pull/158))
...
- **Correct binary_name and binary_path for carbide-rla build** ([#153](https://github.com/NVIDIA/infra-controller-rest/pull/153))
...
- **Verify if VPC Prefixes are present before allowing network Allocation deletion** ([#132](https://github.com/NVIDIA/infra-controller-rest/pull/132))
...
- **Resolve data race in RLA workerpool metrics** ([#145](https://github.com/NVIDIA/infra-controller-rest/pull/145))
...
- **Fix link to Core repo in README** ([#146](https://github.com/NVIDIA/infra-controller-rest/pull/146))
  Corrects a broken documentation link to the BMM Core repository in the README.

- **Fix invalid NVLink Interface order, DPU Extension Service delete code in schema** ([#150](https://github.com/NVIDIA/infra-controller-rest/pull/150))
...
- **Fix NVLink Interfaces endpoint parameters** ([#147](https://github.com/NVIDIA/infra-controller-rest/pull/147))
  Corrects parameter definitions for NVLink Interface endpoints in the OpenAPI schema.

- **Fix schema tag for NVLink Interfaces endpoint** ([#141](https://github.com/NVIDIA/infra-controller-rest/pull/141))
  Fixes incorrect schema tags on the NVLink Interfaces endpoint in the OpenAPI specification.

### CI/CD

- **Add check to ensure SDK and docs are regenerated when OpenAPI spec changes** ([#174](https://github.com/NVIDIA/infra-controller-rest/pull/174))
...
- **Remove duplicate Slack notification trigger in new PR workflow** ([#159](https://github.com/NVIDIA/infra-controller-rest/pull/159))
...
- **Enable Slack notification for all PRs** ([#152](https://github.com/NVIDIA/infra-controller-rest/pull/152))
...
- **Allow privileged Tenants to retrieve all Sites** ([#144](https://github.com/NVIDIA/infra-controller-rest/pull/144))
...
- **Consolidate kustomize objects into carbide-rest namespace** ([#140](https://github.com/NVIDIA/infra-controller-rest/pull/140))
  Consolidates all Kustomize objects into a single `carbide-rest` namespace for cleaner deployment organization.

- **Update RLA Dockerfile ldflags to use bare-metal-manager-rest module path** ([#136](https://github.com/NVIDIA/infra-controller-rest/pull/136))
  Updates Go linker flags in the RLA Dockerfile to use the correct module path after the repository migration.

- **Release SDK for version 1.0.4** ([#142](https://github.com/NVIDIA/infra-controller-rest/pull/142))
  Publishes the generated SDK matching the v1.0.4 API surface.

- **Fix role name and grammar in OpenAPI spec** ([#139](https://github.com/NVIDIA/infra-controller-rest/pull/139))
  Corrects the Provider viewer role name and fixes grammatical errors in the OpenAPI specification.

- **Rename local deployment elements** ([#138](https://github.com/NVIDIA/infra-controller-rest/pull/138))
  Renames internal deployment components (elektraserver to mock-core, cluster name to carbide-rest-local) for clearer naming.

- **Remove vault references in setup** ([#135](https://github.com/NVIDIA/infra-controller-rest/pull/135))
  Cleans up remaining Vault references from the local setup scripts after the migration to native Go PKI.

---

## [v1.0.4-rc1](https://github.com/NVIDIA/infra-controller-rest/releases/tag/v1.0.4-rc1) — 2026-03-05
...
## [v1.0.4](https://github.com/NVIDIA/infra-controller-rest/releases/tag/v1.0.4) — 2026-02-17

### CI/CD

- **Fix version extraction from VERSION file with copyright notice** ([#127](https://github.com/NVIDIA/infra-controller-rest/pull/127))
...
## [v1.0.3](https://github.com/NVIDIA/infra-controller-rest/releases/tag/v1.0.3) — 2026-02-13

### Features

- **Add make command to publish rendered OpenAPI schema to docs/pages** ([#116](https://github.com/NVIDIA/infra-controller-rest/pull/116))
...
- **Add support to filter sites by NVLink Partition** ([#101](https://github.com/NVIDIA/infra-controller-rest/pull/101))
  Enables filtering the Sites list by NVLink Partition, helping users locate sites with specific NVLink configurations.

- **Add API models and endpoints for Rack management** ([#79](https://github.com/NVIDIA/infra-controller-rest/pull/79))
...
- **Use NVLink domain ID instead of rack for batch instance topology optimization** ([#90](https://github.com/NVIDIA/infra-controller-rest/pull/90))
...
- **Replace embedded Vault in Cert Manager with native Go PKI** ([#59](https://github.com/NVIDIA/infra-controller-rest/pull/59))
...
- **Check NVLink, multi-DPU or InfiniBand capability of Machine in Instance create/update** ([#84](https://github.com/NVIDIA/infra-controller-rest/pull/84))
...
- **InfiniBand partition metadata support** ([#69](https://github.com/NVIDIA/infra-controller-rest/pull/69))
...
- **Allow filtering NVLink Interface API endpoint by Instance ID/Logical Partition ID** ([#89](https://github.com/NVIDIA/infra-controller-rest/pull/89))
...
- **Add RLA gRPC client in Site Agent and Site Workflow** ([#67](https://github.com/NVIDIA/infra-controller-rest/pull/67))
...
- **Remove ElasticSearch Temporal dependency from local kind deployment** ([#95](https://github.com/NVIDIA/infra-controller-rest/pull/95))
...
- **Prevent Instance update when missing on Site** ([#124](https://github.com/NVIDIA/infra-controller-rest/pull/124))
...
- **Switch license for Rack management files from NVIDIA to Apache 2.0** ([#118](https://github.com/NVIDIA/infra-controller-rest/pull/118))
...
- **Limit name uniqueness to per Site, per Tenant when creating InfiniBand Partition** ([#107](https://github.com/NVIDIA/infra-controller-rest/pull/107))
...
- **Revise DPU Extension Service deletion and version deletion logic** ([#110](https://github.com/NVIDIA/infra-controller-rest/pull/110))
...
- **Give execution permission to the setup-local.sh script** ([#114](https://github.com/NVIDIA/infra-controller-rest/pull/114))
  Adds execute permission to the local setup script, fixing `make kind-reset` failures.

- **Increase Keycloak memory limit** ([#112](https://github.com/NVIDIA/infra-controller-rest/pull/112))
...
- **Use 127.0.0.1 in the output of make preview-openapi** ([#111](https://github.com/NVIDIA/infra-controller-rest/pull/111))
...
- **Fixed OpenAPI schema issues, added validation scripts** ([#105](https://github.com/NVIDIA/infra-controller-rest/pull/105))
...
- **Send description along with create and update NVLink partition request** ([#87](https://github.com/NVIDIA/infra-controller-rest/pull/87))
...
- **Return Machine board serial, product name and vendor in DMI data** ([#97](https://github.com/NVIDIA/infra-controller-rest/pull/97))
...
- **Check if NVLink Logical Partition is already connected on Instance NVLink Interface update** ([#83](https://github.com/NVIDIA/infra-controller-rest/pull/83))
...
- **Enforce PR title format** ([#100](https://github.com/NVIDIA/infra-controller-rest/pull/100))
...
- **Update API name config, README for OpenAPI schema development** ([#117](https://github.com/NVIDIA/infra-controller-rest/pull/117))
  Adds the missing API name configuration and comprehensive OpenAPI schema development instructions.

- **Update core proto generation command in Makefile** ([#109](https://github.com/NVIDIA/infra-controller-rest/pull/109))
  Updates the Makefile command for regenerating Core protobuf definitions.

- **Update Github Go module path to bare-metal-manager-rest** ([#108](https://github.com/NVIDIA/infra-controller-rest/pull/108))
  Migrates the Go module path to the new GitHub repository location.

- **Start renaming Carbide to NVIDIA Metal Manager** ([#99](https://github.com/NVIDIA/infra-controller-rest/pull/99))
  Begins the rebranding effort from Carbide to NVIDIA Metal Manager across documentation and configuration.

- **Regenerate third party license file** ([#103](https://github.com/NVIDIA/infra-controller-rest/pull/103))
  Regenerates the third-party license file to reflect current dependency state.

- **Update license file to Apache 2.0, remove NVIDIA license file headers** ([#93](https://github.com/NVIDIA/infra-controller-rest/pull/93))
  Converts the project license to Apache 2.0 and removes proprietary NVIDIA license headers from source files.

- **Update Temporal and Postgres URLs to use local DNS** ([#98](https://github.com/NVIDIA/infra-controller-rest/pull/98))
  Updates service URLs to use Kubernetes local DNS names for improved reliability in local development environments.

- **Add GitHub interaction templates and code of conduct** ([#96](https://github.com/NVIDIA/infra-controller-rest/pull/96))
  Adds GitHub issue templates, discussion templates, and a code of conduct to standardize community interactions.

- **Upgrade otelecho to v0.65.0 to fix security vulnerability** ([#91](https://github.com/NVIDIA/infra-controller-rest/pull/91))
  Updates the OpenTelemetry Echo middleware to address a known security vulnerability.

- **Remove Kubernetes files** ([#94](https://github.com/NVIDIA/infra-controller-rest/pull/94))
  Removes legacy Kubernetes manifest files that have been superseded by Helm charts and Kustomize.

---

## [v1.0.2](https://github.com/NVIDIA/infra-controller-rest/releases/tag/v1.0.2) — 2026-01-29

### CI/CD

- **Use revised matching regex for release tags** ([#81](https://github.com/NVIDIA/infra-controller-rest/pull/81))
...
## [v1.0.1](https://github.com/NVIDIA/infra-controller-rest/releases/tag/v1.0.1) — 2026-01-28

### Features

- **Add proto and protobuf for RLA gRPC API** ([#66](https://github.com/NVIDIA/infra-controller-rest/pull/66))
...
- **Support custom claims for JWT issuers** ([#41](https://github.com/NVIDIA/infra-controller-rest/pull/41))
...
- **Add schema for Instance batch API** ([#61](https://github.com/NVIDIA/infra-controller-rest/pull/61))
  Adds OpenAPI schema documentation for the instance batch creation API endpoint.

- **Enable license scanning** ([#64](https://github.com/NVIDIA/infra-controller-rest/pull/64))
  Adds automated license scanning to the CI pipeline for dependency compliance verification.

### Bug Fixes

- **Revise NVLink Logical Partition inventory metadata update logic** ([#74](https://github.com/NVIDIA/infra-controller-rest/pull/74))
...
- **Missing body close on HTTP responses** ([#71](https://github.com/NVIDIA/infra-controller-rest/pull/71))
  Adds deferred `Body.Close()` calls on HTTP responses in Slack notification code, preventing resource leaks.

- **Verify provided version in DPU Extension Service active version list for deletion** ([#63](https://github.com/NVIDIA/infra-controller-rest/pull/63))
...
- **Fix docker image artifact path in upload workflow** ([#78](https://github.com/NVIDIA/infra-controller-rest/pull/78))
  Aligns the Docker image artifact path in the upload workflow with the actual location of built images.

- **Fix docker image tag for artifact extraction/upload in workflows** ([#77](https://github.com/NVIDIA/infra-controller-rest/pull/77))
  Corrects Docker image tags used during artifact extraction to match the updated image naming convention.

- **Add pre-commit for secrets scanning** ([#68](https://github.com/NVIDIA/infra-controller-rest/pull/68))
  Integrates TruffleHog as a pre-commit hook for automated secrets scanning, preventing accidental credential commits.

### Chores

- **Update scanner actions with improved PR comment handling** ([#75](https://github.com/NVIDIA/infra-controller-rest/pull/75))
...
- **Refactor and optimize Instance API handlers** ([#60](https://github.com/NVIDIA/infra-controller-rest/pull/60))
...
- **Revise docker image push policy** ([#62](https://github.com/NVIDIA/infra-controller-rest/pull/62))
...
## [v1.0.0](https://github.com/NVIDIA/infra-controller-rest/releases/tag/v1.0.0) — 2026-01-20

### Features

- **Add support for bulk creation/update of Expected Machines** ([#35](https://github.com/NVIDIA/infra-controller-rest/pull/35))
...
- **Add unique DB index for Expected Machine BMC MAC address per Site** ([#36](https://github.com/NVIDIA/infra-controller-rest/pull/36))
...
- **Embed Vault in cert-manager pod** ([#50](https://github.com/NVIDIA/infra-controller-rest/pull/50))
...
- **Retry local site creation during setup** ([#45](https://github.com/NVIDIA/infra-controller-rest/pull/45))
...
- **Add name as orderBy field in DpuExtensionService** ([#53](https://github.com/NVIDIA/infra-controller-rest/pull/53))
  Adds `name` as a valid ordering field for DPU Extension Service list queries.

- **Update OpenAPI spec with NVLink schema and DPU Extension Service modifications** ([#52](https://github.com/NVIDIA/infra-controller-rest/pull/52))
  Updates the OpenAPI schema to include NVLink-related schemas and corrects DPU Extension Service endpoint definitions.

- **Make sure NVLink interface is marked as Pending when sending update request** ([#40](https://github.com/NVIDIA/infra-controller-rest/pull/40))
...
- **Fix inconsistent test data for MachineCapability GetAll tests** ([#34](https://github.com/NVIDIA/infra-controller-rest/pull/34))
  Corrects test fixtures that were producing inconsistent results in MachineCapability GetAll test cases.

- **Wait for mock Carbide server to be up before running site-agent tests** ([#37](https://github.com/NVIDIA/infra-controller-rest/pull/37))
...
- **Only run promotion workflow on main branch** ([#42](https://github.com/NVIDIA/infra-controller-rest/pull/42))
...
- **Updated Go version to 1.25.4 and fixed unit tests** ([#31](https://github.com/NVIDIA/infra-controller-rest/pull/31))
  Upgrades the Go toolchain to 1.25.4 across all modules and fixes unit tests affected by the version change.

- **Add golangci-lint and revive config files** ([#30](https://github.com/NVIDIA/infra-controller-rest/pull/30))
...
- **Revise Slack notification payload for new PR** ([#57](https://github.com/NVIDIA/infra-controller-rest/pull/57))
  Fixes the Slack notification message format for new pull request events.

### Chores

- **Update API version in schema, add local preview script** ([#44](https://github.com/NVIDIA/infra-controller-rest/pull/44))
...
- **Enable binary/docker build for all branches, add security scans** ([#54](https://github.com/NVIDIA/infra-controller-rest/pull/54))
...
- **Do not accept all whitespace strings in Expected Machine attributes and labels** ([#49](https://github.com/NVIDIA/infra-controller-rest/pull/49))
...
- **Improve SiteID validation for APIExpectedMachineUpdateRequest** ([#46](https://github.com/NVIDIA/infra-controller-rest/pull/46))
...
- **Set up binaries build action and build condition** ([#43](https://github.com/NVIDIA/infra-controller-rest/pull/43))
