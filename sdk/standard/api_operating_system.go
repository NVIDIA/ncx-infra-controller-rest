...
`ipxeScript`, `ipxeTemplateId`, and `imageUrl` are mutually exclusive — only one may be specified. When `ipxeTemplateId` is used, `ipxeParameters` and `ipxeArtifacts` can be provided to configure the template.
