...
func (o *ExpectedSwitchUpdateRequest) GetFirmwareVersion() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ExpectedSwitchUpdateRequest) GetFirmwareVersionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ExpectedSwitchUpdateRequest) HasFirmwareVersion() bool {
...
func (o *ExpectedSwitchUpdateRequest) SetFirmwareVersion(v string) {
	o.FirmwareVersion.Set(&v)
}

// SetFirmwareVersionNil sets the value for FirmwareVersion to be an explicit nil
func (o *ExpectedSwitchUpdateRequest) SetFirmwareVersionNil() {
...
func (o *ExpectedSwitchUpdateRequest) UnsetFirmwareVersion() {
