...
func (o *ExpectedMachine) GetFirmwareVersion() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ExpectedMachine) GetFirmwareVersionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ExpectedMachine) HasFirmwareVersion() bool {
...
func (o *ExpectedMachine) UnsetFirmwareVersion() {
