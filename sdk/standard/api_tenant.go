...
type ApiUpdateTenantCapabilitiesRequest struct {
	ctx                             context.Context
	ApiService                      *TenantAPIService
	org                             string
	tenantId                        string
	tenantCapabilitiesUpdateRequest *TenantCapabilitiesUpdateRequest
}

// Optional capability flags. An empty request body is accepted.
func (r ApiUpdateTenantCapabilitiesRequest) TenantCapabilitiesUpdateRequest(tenantCapabilitiesUpdateRequest TenantCapabilitiesUpdateRequest) ApiUpdateTenantCapabilitiesRequest {
	r.tenantCapabilitiesUpdateRequest = &tenantCapabilitiesUpdateRequest
	return r
}

func (r ApiUpdateTenantCapabilitiesRequest) Execute() (*Tenant, *http.Response, error) {
	return r.ApiService.UpdateTenantCapabilitiesExecute(r)
}

/*
UpdateTenantCapabilities Update Tenant capabilities
...
User must have `FORGE_PROVIDER_ADMIN` authorization role.
	...
	@return ApiUpdateTenantCapabilitiesRequest
*/
func (a *TenantAPIService) UpdateTenantCapabilities(ctx context.Context, org string, tenantId string) ApiUpdateTenantCapabilitiesRequest {
	return ApiUpdateTenantCapabilitiesRequest{
		ApiService: a,
		ctx:        ctx,
		org:        org,
...
//
//	@return Tenant
func (a *TenantAPIService) UpdateTenantCapabilitiesExecute(r ApiUpdateTenantCapabilitiesRequest) (*Tenant, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TenantAPIService.UpdateTenantCapabilities")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/org/{org}/carbide/tenant/{tenantId}/capabilities"
	localVarPath = strings.Replace(localVarPath, "{"+"org"+"}", url.PathEscape(parameterValueToString(r.org, "org")), -1)
	...
	// body params
	localVarPostBody = r.tenantCapabilitiesUpdateRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
