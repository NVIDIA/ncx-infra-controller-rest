...
func (o *ExpectedMachineCreateRequest) GetFirmwareVersion() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ExpectedMachineCreateRequest) GetFirmwareVersionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ExpectedMachineCreateRequest) HasFirmwareVersion() bool {
...
func (o *ExpectedMachineCreateRequest) SetFirmwareVersion(v string) {
	o.FirmwareVersion.Set(&v)
}

// SetFirmwareVersionNil sets the value for FirmwareVersion to be an explicit nil
func (o *ExpectedMachineCreateRequest) SetFirmwareVersionNil() {
...
func (o *ExpectedMachineCreateRequest) UnsetFirmwareVersion() {
