...
// NewInfiniBandPartitionManager - returns a new instance of helm manager
func NewInfiniBandPartitionManager(superForge *elektratypes.Elektra, superAPI *Manager.ManagerAPI, superConf *Manager.ManagerConf) *API {
