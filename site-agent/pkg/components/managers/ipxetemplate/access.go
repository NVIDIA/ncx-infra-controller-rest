...
// NewIpxeTemplateManager - returns a new instance of IpxeTemplate manager
func NewIpxeTemplateManager(superForge *elektratypes.Elektra, superAPI *Manager.ManagerAPI, superConf *Manager.ManagerConf) *API {
