...
// NewTenantManager - returns a new instance of Tenant manager
func NewTenantManager(superForge *elektratypes.Elektra, superAPI *Manager.ManagerAPI, superConf *Manager.ManagerConf) *API {
