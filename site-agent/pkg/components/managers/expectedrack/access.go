...
// NewExpectedRackManager - returns a new instance of expected rack manager
func NewExpectedRackManager(superForge *elektratypes.Elektra, superAPI *Manager.ManagerAPI, superConf *Manager.ManagerConf) *API {
