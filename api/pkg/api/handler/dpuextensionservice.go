...
func (cdesh CreateDpuExtensionServiceHandler) Handle(c echo.Context) error {
	...
	if apiRequest.Observability != nil {
		createDpuExtensionServiceRequest.Observability = model.ProtobufObservabilityFromAPIDpuExtensionServiceObservability(apiRequest.Observability).DpuExtensionServiceObservability
	}
	...
	if controllerDpuExtensionService != nil && controllerDpuExtensionService.LatestVersionInfo != nil {
		...
		versionInfo := model.DBDpuExtensionServiceVersionInfoFromProto(controllerDpuExtensionService.LatestVersionInfo, dpuExtensionService.Created)
...
func (udesh UpdateDpuExtensionServiceHandler) Handle(c echo.Context) error {
	...
	if apiRequest.Observability != nil {
		updateDpuExtensionServiceRequest.Observability = model.ProtobufObservabilityFromAPIDpuExtensionServiceObservability(apiRequest.Observability).DpuExtensionServiceObservability
	}
	...
	if controllerDpuExtensionService != nil && controllerDpuExtensionService.LatestVersionInfo != nil {
		version := controllerDpuExtensionService.LatestVersionInfo.Version
		activeVersions := controllerDpuExtensionService.ActiveVersions
		versionInfo := model.DBDpuExtensionServiceVersionInfoFromProto(controllerDpuExtensionService.LatestVersionInfo, updatedDpuExtensionService.Updated)
		status := cdbm.DpuExtensionServiceStatusReady
...
func (gdesvh GetDpuExtensionServiceVersionHandler) Handle(c echo.Context) error {
	...
	apiVersionInfo := model.APIDpuExtensionServiceVersionInfoFromProto(versionInfo, dpuExtensionService.Updated)
...
func (ddesvh DeleteDpuExtensionServiceVersionHandler) Handle(c echo.Context) error {
	...
	if fetchLatestRemainingVersion {
		...
		if controllerVersionInfo != nil {
			versionInfo := model.DBDpuExtensionServiceVersionInfoFromProto(controllerVersionInfo, dpuExtensionService.Updated)
