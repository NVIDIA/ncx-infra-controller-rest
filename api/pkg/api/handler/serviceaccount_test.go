...
func TestServiceAccountHandler_GetCurrent(t *testing.T) {
	...
	org1 := "test-org"
	user1 := common.TestBuildUser(t, dbSession, uuid.NewString(), org1, []string{"NICO_PROVIDER_ADMIN", "NICO_TENANT_ADMIN"})

	org2 := "test-org-2"
	user2 := common.TestBuildUser(t, dbSession, uuid.NewString(), org2, []string{"NICO_PROVIDER_ADMIN", "NICO_TENANT_ADMIN"})
	...
	org3 := "test-org-3"
	user3 := common.TestBuildUser(t, dbSession, uuid.NewString(), org3, []string{"NICO_TENANT_ADMIN"})
