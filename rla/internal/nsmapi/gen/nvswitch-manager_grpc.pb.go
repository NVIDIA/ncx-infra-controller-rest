...
type NVSwitchManagerClient interface {
	...
	ListBundles(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ListBundlesResponse, error)
	...
	GetAllUpdates(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GetAllUpdatesResponse, error)
...
func (c *nVSwitchManagerClient) ListBundles(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ListBundlesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *nVSwitchManagerClient) GetAllUpdates(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GetAllUpdatesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type NVSwitchManagerServer interface {
	...
	// Firmware Management (New API)
	// ListBundles returns all available firmware bundles.
	ListBundles(context.Context, *empty.Empty) (*ListBundlesResponse, error)
	// QueueUpdate queues firmware updates for one or more components (or all if not specified).
	...
	// GetAllUpdates returns all firmware updates across all switches.
	GetAllUpdates(context.Context, *empty.Empty) (*GetAllUpdatesResponse, error)
	// CancelUpdate cancels an in-progress firmware update.
...
func (UnimplementedNVSwitchManagerServer) RegisterNVSwitches(context.Context, *RegisterNVSwitchesRequest) (*RegisterNVSwitchesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterNVSwitches not implemented")
}
func (UnimplementedNVSwitchManagerServer) GetNVSwitches(context.Context, *NVSwitchRequest) (*GetNVSwitchesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetNVSwitches not implemented")
}
func (UnimplementedNVSwitchManagerServer) ListBundles(context.Context, *empty.Empty) (*ListBundlesResponse, error) {
...
func (UnimplementedNVSwitchManagerServer) QueueUpdates(context.Context, *QueueUpdatesRequest) (*QueueUpdatesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method QueueUpdates not implemented")
}
...
func (UnimplementedNVSwitchManagerServer) GetUpdatesForSwitch(context.Context, *GetUpdatesForSwitchRequest) (*GetUpdatesForSwitchResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUpdatesForSwitch not implemented")
}
func (UnimplementedNVSwitchManagerServer) GetAllUpdates(context.Context, *empty.Empty) (*GetAllUpdatesResponse, error) {
...
func (UnimplementedNVSwitchManagerServer) CancelUpdate(context.Context, *CancelUpdateRequest) (*CancelUpdateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CancelUpdate not implemented")
}
func (UnimplementedNVSwitchManagerServer) PowerControl(context.Context, *PowerControlRequest) (*PowerControlResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PowerControl not implemented")
}
...
func RegisterNVSwitchManagerServer(s grpc.ServiceRegistrar, srv NVSwitchManagerServer) {
	// If the following call pancis, it indicates UnimplementedNVSwitchManagerServer was
...
func _NVSwitchManager_ListBundles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NVSwitchManagerServer).ListBundles(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _NVSwitchManager_GetAllUpdates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NVSwitchManagerServer).GetAllUpdates(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
