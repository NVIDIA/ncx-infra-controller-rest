...
type EndpointExplorationReport struct {
	...
	LastExplorationLatency *duration.Duration `protobuf:"bytes,4,opt,name=last_exploration_latency,json=lastExplorationLatency,proto3,oneof" json:"last_exploration_latency,omitempty"`
...
func (x *EndpointExplorationReport) GetLastExplorationLatency() *duration.Duration {
	if x != nil {
...
type Chassis struct {
	...
	// Power supplies discovered via Redfish PowerSubsystem (power shelves)
	PowerSupplies []*PowerSupplyUnit `protobuf:"bytes,7,rep,name=power_supplies,json=powerSupplies,proto3" json:"power_supplies,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Chassis) GetPowerSupplies() []*PowerSupplyUnit {
	if x != nil {
...
// `PowerSupplyUnit` from Redfish PowerSubsystem/PowerSupplies
type PowerSupplyUnit struct {
	...
	SerialNumber    *string                `protobuf:"bytes,5,opt,name=serial_number,json=serialNumber,proto3,oneof" json:"serial_number,omitempty"`
	FirmwareVersion *string                `protobuf:"bytes,6,opt,name=firmware_version,json=firmwareVersion,proto3,oneof" json:"firmware_version,omitempty"`
	// true = on, false = off; absent when unknown
	PowerState    *bool `protobuf:"varint,7,opt,name=power_state,json=powerState,proto3,oneof" json:"power_state,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_site_explorer_proto_rawDesc = "" +
	...
	"\rserial_number\x18\x05 \x01(\tH\x03R\fserialNumber\x88\x01\x01\x12E\n" +
	"\x0epower_supplies\x18\a \x03(\v2\x1e.site_explorer.PowerSupplyUnitR\rpowerSuppliesB\x0f\n" +
	"\r_manufacturerB\b\n" +
	"\x06_modelB\x0e\n" +
	"\f_part_numberB\x10\n" +
	"\x0e_serial_number\"\xd9\x02\n" +
	"\x0fPowerSupplyUnit\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x17\n" +
	"\x04name\x18\x02 \x01(\tH\x00R\x04name\x88\x01\x01\x12'\n" +
	"\fmanufacturer\x18\x03 \x01(\tH\x01R\fmanufacturer\x88\x01\x01\x12\x19\n" +
	"\x05model\x18\x04 \x01(\tH\x02R\x05model\x88\x01\x01\x12(\n" +
	"\rserial_number\x18\x05 \x01(\tH\x03R\fserialNumber\x88\x01\x01\x12.\n" +
	"\x10firmware_version\x18\x06 \x01(\tH\x04R\x0ffirmwareVersion\x88\x01\x01\x12$\n" +
	"\vpower_state\x18\a \x01(\bH\x05R\n" +
	"powerState\x88\x01\x01B\a\n" +
	"\x05_nameB\x0f\n" +
	"\r_manufacturerB\b\n" +
	"\x06_modelB\x10\n" +
	"\x0e_serial_numberB\x13\n" +
	"\x11_firmware_versionB\x0e\n" +
	"\f_power_state\"\xf1\x01\n" +
...
var file_site_explorer_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_site_explorer_proto_goTypes = []any{
	...
	(*PowerSupplyUnit)(nil),                  // 21: site_explorer.PowerSupplyUnit
	(*NetworkAdapter)(nil),                   // 22: site_explorer.NetworkAdapter
	(*Service)(nil),                          // 23: site_explorer.Service
	(*Inventory)(nil),                        // 24: site_explorer.Inventory
	(*MachineSetupStatus)(nil),               // 25: site_explorer.MachineSetupStatus
	(*MachineSetupDiff)(nil),                 // 26: site_explorer.MachineSetupDiff
	(*PCIeDevice)(nil),                       // 27: site_explorer.PCIeDevice
	(*SystemStatus)(nil),                     // 28: site_explorer.SystemStatus
	(*BootOrder)(nil),                        // 29: site_explorer.BootOrder
	(*BootOption)(nil),                       // 30: site_explorer.BootOption
	(*SecureBootStatus)(nil),                 // 31: site_explorer.SecureBootStatus
	(*LockdownStatus)(nil),                   // 32: site_explorer.LockdownStatus
	nil,                                      // 33: site_explorer.EndpointExplorationReport.FirmwareVersionsEntry
	(*duration.Duration)(nil),                // 34: google.protobuf.Duration
}
var file_site_explorer_proto_depIdxs = []int32{
	34, // 0: site_explorer.EndpointExplorationReport.last_exploration_latency:type_name -> google.protobuf.Duration
	...
	23, // 4: site_explorer.EndpointExplorationReport.service:type_name -> site_explorer.Service
	25, // 5: site_explorer.EndpointExplorationReport.machine_setup_status:type_name -> site_explorer.MachineSetupStatus
	31, // 6: site_explorer.EndpointExplorationReport.secure_boot_status:type_name -> site_explorer.SecureBootStatus
	32, // 7: site_explorer.EndpointExplorationReport.lockdown_status:type_name -> site_explorer.LockdownStatus
	33, // 8: site_explorer.EndpointExplorationReport.firmware_versions:type_name -> site_explorer.EndpointExplorationReport.FirmwareVersionsEntry
	...
	27, // 18: site_explorer.ComputerSystem.pcie_devices:type_name -> site_explorer.PCIeDevice
	1,  // 19: site_explorer.ComputerSystem.power_state:type_name -> site_explorer.ComputerSystemPowerState
	29, // 20: site_explorer.ComputerSystem.boot_order:type_name -> site_explorer.BootOrder
	19, // 21: site_explorer.Manager.ethernet_interfaces:type_name -> site_explorer.EthernetInterface
	22, // 22: site_explorer.Chassis.network_adapters:type_name -> site_explorer.NetworkAdapter
	21, // 23: site_explorer.Chassis.power_supplies:type_name -> site_explorer.PowerSupplyUnit
	24, // 24: site_explorer.Service.inventories:type_name -> site_explorer.Inventory
	26, // 25: site_explorer.MachineSetupStatus.diffs:type_name -> site_explorer.MachineSetupDiff
	28, // 26: site_explorer.PCIeDevice.status:type_name -> site_explorer.SystemStatus
	30, // 27: site_explorer.BootOrder.boot_order:type_name -> site_explorer.BootOption
	2,  // 28: site_explorer.LockdownStatus.status:type_name -> site_explorer.InternalLockdownStatus
...
func file_site_explorer_proto_init() {
	...
	file_site_explorer_proto_msgTypes[27].OneofWrappers = []any{}
	type x struct{}
