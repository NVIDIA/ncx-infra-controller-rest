...
const (
	...
	RLA_BringDownRack_FullMethodName            = "/v1.RLA/BringDownRack"
...
type RLAClient interface {
	...
	BringDownRack(ctx context.Context, in *BringDownRackRequest, opts ...grpc.CallOption) (*SubmitTaskResponse, error)
...
func (c *rLAClient) BringDownRack(ctx context.Context, in *BringDownRackRequest, opts ...grpc.CallOption) (*SubmitTaskResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SubmitTaskResponse)
	err := c.cc.Invoke(ctx, RLA_BringDownRack_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RLAServer interface {
	...
	BringDownRack(context.Context, *BringDownRackRequest) (*SubmitTaskResponse, error)
...
func (UnimplementedRLAServer) BringDownRack(context.Context, *BringDownRackRequest) (*SubmitTaskResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BringDownRack not implemented")
}
...
func _RLA_BringDownRack_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BringDownRackRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RLAServer).BringDownRack(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RLA_BringDownRack_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RLAServer).BringDownRack(ctx, req.(*BringDownRackRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RLA_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BringDownRack",
			Handler:    _RLA_BringDownRack_Handler,
		},
		{
