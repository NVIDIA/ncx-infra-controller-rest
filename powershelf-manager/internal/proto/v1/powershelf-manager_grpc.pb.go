...
type PowershelfManagerClient interface {
	...
	SetDryRun(ctx context.Context, in *SetDryRunRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	// Power Control
	// Power OFF the rack
...
func (c *powershelfManagerClient) SetDryRun(ctx context.Context, in *SetDryRunRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
type PowershelfManagerServer interface {
	...
	// SetDryRun configures whether the firmware manager is in Dry Run mode.
	SetDryRun(context.Context, *SetDryRunRequest) (*empty.Empty, error)
	// Power Control
	// Power OFF the rack
...
func (UnimplementedPowershelfManagerServer) RegisterPowershelves(context.Context, *RegisterPowershelvesRequest) (*RegisterPowershelvesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterPowershelves not implemented")
}
func (UnimplementedPowershelfManagerServer) GetPowershelves(context.Context, *PowershelfRequest) (*GetPowershelvesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPowershelves not implemented")
}
...
func (UnimplementedPowershelfManagerServer) ListAvailableFirmware(context.Context, *PowershelfRequest) (*ListAvailableFirmwareResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListAvailableFirmware not implemented")
}
func (UnimplementedPowershelfManagerServer) SetDryRun(context.Context, *SetDryRunRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetDryRun not implemented")
}
...
func RegisterPowershelfManagerServer(s grpc.ServiceRegistrar, srv PowershelfManagerServer) {
	// If the following call pancis, it indicates UnimplementedPowershelfManagerServer was
