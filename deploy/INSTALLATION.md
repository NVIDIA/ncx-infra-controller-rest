...
- **Realm roles:** `admin`, `user`, `test-org:NICO_PROVIDER_ADMIN`, `test-org:NICO_TENANT_ADMIN`, `test-org:NICO_PROVIDER_VIEWER`
- **Pre-seeded dev users:**

  | Username | Password | Roles |
  |---|---|---|
  | `testuser` | `testpassword` | `user`, `test-org:NICO_TENANT_ADMIN` |
  | `admin` | `adminpassword` | `admin`, `user`, `test-org:NICO_PROVIDER_ADMIN`, `test-org:NICO_TENANT_ADMIN` |
  | `provider` | `providerpassword` | `user`, `test-org:NICO_PROVIDER_ADMIN` |
