...
|---|---|---|
| `CARBIDE_ADDRESS` | `carbide-rest-mock-core:11079` | Carbide/Forge gRPC endpoint — **set this to your [NVIDIA Infrastructure Controller Core](https://github.com/NVIDIA/ncx-infra-controller-core) address in production** |
