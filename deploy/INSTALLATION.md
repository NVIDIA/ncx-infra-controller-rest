...
- **Co-located:** The REST layer and [NCX Infra Controller Core](https://github.com/NVIDIA/bare-metal-manager-core) run together in the same datacenter cluster.
...
|---|---|---|
| `CARBIDE_ADDRESS` | `carbide-rest-mock-core:11079` | Carbide/Forge gRPC endpoint — **set this to your [NCX Infra Controller Core](https://github.com/NVIDIA/bare-metal-manager-core) address in production** |
