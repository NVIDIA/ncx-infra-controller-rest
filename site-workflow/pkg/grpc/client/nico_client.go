...
// Networks Getter
func (client *NicoClient) Networks() NetworkInterface {
	return newNetwork(client.nico)
}

// Compute Getter
func (client *NicoClient) Compute() ComputeInterface {
	return newCompute(client.nico)
}
