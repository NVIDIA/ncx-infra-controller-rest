...
func (c *MockForgeClient) FindOperatingSystemsByIds(ctx context.Context, in *wflows.OperatingSystemsByIdsRequest, opts ...grpc.CallOption) (*wflows.OperatingSystemList, error) {
	...
	for i, id := range in.GetIds() {
		out.OperatingSystems = append(out.OperatingSystems, &wflows.OperatingSystemDefinition{
			Id:                   id,
...
func (c *MockForgeClient) CreateOperatingSystem(ctx context.Context, in *wflows.CreateOperatingSystemRequest, opts ...grpc.CallOption) (*wflows.OperatingSystemDefinition, error) {
	if err, ok := ctx.Value("wantError").(error); ok {
		return nil, err
	}
	return &wflows.OperatingSystemDefinition{
...
func (c *MockForgeClient) UpdateOperatingSystem(ctx context.Context, in *wflows.UpdateOperatingSystemRequest, opts ...grpc.CallOption) (*wflows.OperatingSystemDefinition, error) {
	if err, ok := ctx.Value("wantError").(error); ok {
		return nil, err
	}
	return &wflows.OperatingSystemDefinition{
