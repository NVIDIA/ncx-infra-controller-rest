...
// 	protoc        (unknown)
// source: network_security_group.proto
...
// NetworkSecurityGroupInventory - inventory info for all NetworkSecurityGroups periodically collected
...
func (x *NetworkSecurityGroupInventory) Reset() {
	*x = NetworkSecurityGroupInventory{}
	mi := &file_network_security_group_proto_msgTypes[0]
...
func (*NetworkSecurityGroupInventory) Descriptor() ([]byte, []int) {
	return file_network_security_group_proto_rawDescGZIP(), []int{0}
}
...
var File_network_security_group_proto protoreflect.FileDescriptor
...
var (
	file_network_security_group_proto_rawDescOnce sync.Once
	file_network_security_group_proto_rawDescData []byte
)

func file_network_security_group_proto_rawDescGZIP() []byte {
	file_network_security_group_proto_rawDescOnce.Do(func() {
		file_network_security_group_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_network_security_group_proto_rawDesc), len(file_network_security_group_proto_rawDesc)))
	})
	return file_network_security_group_proto_rawDescData
}
...
func init() { file_network_security_group_proto_init() }
func file_network_security_group_proto_init() {
	if File_network_security_group_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_network_security_group_proto_rawDesc), len(file_network_security_group_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_network_security_group_proto_goTypes,
		DependencyIndexes: file_network_security_group_proto_depIdxs,
		MessageInfos:      file_network_security_group_proto_msgTypes,
	}.Build()
	File_network_security_group_proto = out.File
	file_network_security_group_proto_goTypes = nil
	file_network_security_group_proto_depIdxs = nil
}
