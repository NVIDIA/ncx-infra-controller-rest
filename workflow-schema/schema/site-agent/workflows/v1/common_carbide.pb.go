...
func (x *OperatingSystemId) Reset() {
	*x = OperatingSystemId{}
	mi := &file_common_carbide_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OperatingSystemId) Descriptor() ([]byte, []int) {
	return file_common_carbide_proto_rawDescGZIP(), []int{24}
}
...
func (x *IpxeTemplateId) Reset() {
	*x = IpxeTemplateId{}
	mi := &file_common_carbide_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IpxeTemplateId) Descriptor() ([]byte, []int) {
	return file_common_carbide_proto_rawDescGZIP(), []int{25}
}
