...
// OsImageInventory - inventory info for all OsImages periodically collected
...
func (x *OsImageInventory) Reset() {
	*x = OsImageInventory{}
	mi := &file_operatingsystem_proto_msgTypes[0]
...
func (*OsImageInventory) Descriptor() ([]byte, []int) {
	return file_operatingsystem_proto_rawDescGZIP(), []int{0}
}
...
type OperatingSystemInventory struct {
	...
	OperatingSystems []*OperatingSystemDefinition `protobuf:"bytes,1,rep,name=operating_systems,json=operatingSystems,proto3" json:"operating_systems,omitempty"`
	// Reported timestamp of inventory
	Timestamp *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	// Status of Inventory
	InventoryStatus InventoryStatus `protobuf:"varint,3,opt,name=inventory_status,json=inventoryStatus,proto3,enum=workflows.v1.InventoryStatus" json:"inventory_status,omitempty"`
...
func (x *OperatingSystemInventory) GetOperatingSystems() []*OperatingSystemDefinition {
	if x != nil {
...
const file_operatingsystem_proto_rawDesc = "" +
	...
	"\x0einventory_page\x18\x05 \x01(\v2\x1b.workflows.v1.InventoryPageR\rinventoryPage\"\xd0\x02\n" +
	"\x18OperatingSystemInventory\x12M\n" +
	"\x11operating_systems\x18\x01 \x03(\v2 .forge.OperatingSystemDefinitionR\x10operatingSystems\x128\n" +
	"\ttimestamp\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\x12H\n" +
	"\x10inventory_status\x18\x03 \x01(\x0e2\x1d.workflows.v1.InventoryStatusR\x0finventoryStatus\x12\x1d\n" +
	"\n" +
	"status_msg\x18\x04 \x01(\tR\tstatusMsg\x12B\n" +
...
var (
	...
	file_operatingsystem_proto_rawDescData []byte
)

func file_operatingsystem_proto_rawDescGZIP() []byte {
	file_operatingsystem_proto_rawDescOnce.Do(func() {
		file_operatingsystem_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_operatingsystem_proto_rawDesc), len(file_operatingsystem_proto_rawDesc)))
	})
...
var file_operatingsystem_proto_goTypes = []any{
	...
	(*OperatingSystemDefinition)(nil), // 6: forge.OperatingSystemDefinition
}
var file_operatingsystem_proto_depIdxs = []int32{
	...
	6, // 4: workflows.v1.OperatingSystemInventory.operating_systems:type_name -> forge.OperatingSystemDefinition
...
func file_operatingsystem_proto_init() {
	if File_operatingsystem_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_operatingsystem_proto_goTypes,
		DependencyIndexes: file_operatingsystem_proto_depIdxs,
		MessageInfos:      file_operatingsystem_proto_msgTypes,
	}.Build()
	File_operatingsystem_proto = out.File
	file_operatingsystem_proto_goTypes = nil
	file_operatingsystem_proto_depIdxs = nil
}
