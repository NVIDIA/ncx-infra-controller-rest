...
func (x *IpxeTemplateInventory) Reset() {
	*x = IpxeTemplateInventory{}
	mi := &file_ipxetemplate_proto_msgTypes[0]
...
func (*IpxeTemplateInventory) Descriptor() ([]byte, []int) {
	return file_ipxetemplate_proto_rawDescGZIP(), []int{0}
}
...
var File_ipxetemplate_proto protoreflect.FileDescriptor
...
var (
	file_ipxetemplate_proto_rawDescOnce sync.Once
	file_ipxetemplate_proto_rawDescData []byte
)

func file_ipxetemplate_proto_rawDescGZIP() []byte {
	file_ipxetemplate_proto_rawDescOnce.Do(func() {
		file_ipxetemplate_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_ipxetemplate_proto_rawDesc), len(file_ipxetemplate_proto_rawDesc)))
	})
	return file_ipxetemplate_proto_rawDescData
}

var file_ipxetemplate_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_ipxetemplate_proto_goTypes = []any{
...
func init() { file_ipxetemplate_proto_init() }
func file_ipxetemplate_proto_init() {
	if File_ipxetemplate_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ipxetemplate_proto_rawDesc), len(file_ipxetemplate_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_ipxetemplate_proto_goTypes,
		DependencyIndexes: file_ipxetemplate_proto_depIdxs,
		MessageInfos:      file_ipxetemplate_proto_msgTypes,
	}.Build()
	File_ipxetemplate_proto = out.File
	file_ipxetemplate_proto_goTypes = nil
	file_ipxetemplate_proto_depIdxs = nil
}
