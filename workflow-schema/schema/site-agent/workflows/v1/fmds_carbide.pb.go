...
func (x *UpdateConfigRequest) Reset() {
	*x = UpdateConfigRequest{}
	mi := &file_fmds_carbide_proto_msgTypes[0]
...
func (*UpdateConfigRequest) Descriptor() ([]byte, []int) {
	return file_fmds_carbide_proto_rawDescGZIP(), []int{0}
}
...
func (x *UpdateConfigResponse) Reset() {
	*x = UpdateConfigResponse{}
	mi := &file_fmds_carbide_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateConfigResponse) Descriptor() ([]byte, []int) {
	return file_fmds_carbide_proto_rawDescGZIP(), []int{1}
}
...
func (x *FmdsConfigUpdate) Reset() {
	*x = FmdsConfigUpdate{}
	mi := &file_fmds_carbide_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FmdsConfigUpdate) Descriptor() ([]byte, []int) {
	return file_fmds_carbide_proto_rawDescGZIP(), []int{2}
}
...
func (x *IBDevice) Reset() {
	*x = IBDevice{}
	mi := &file_fmds_carbide_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IBDevice) Descriptor() ([]byte, []int) {
	return file_fmds_carbide_proto_rawDescGZIP(), []int{3}
}
...
func (x *IBInstance) Reset() {
	*x = IBInstance{}
	mi := &file_fmds_carbide_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IBInstance) Descriptor() ([]byte, []int) {
	return file_fmds_carbide_proto_rawDescGZIP(), []int{4}
}
...
var File_fmds_carbide_proto protoreflect.FileDescriptor

const file_fmds_carbide_proto_rawDesc = "" +
	"\n" +
	"\x12fmds_carbide.proto\x12\x04fmds\x1a\x14common_carbide.proto\"R\n" +
	...
	"\fUpdateConfig\x12\x19.fmds.UpdateConfigRequest\x1a\x1a.fmds.UpdateConfigResponseBCZAgithub.com/NVIDIA/ncx-infra-controller-rest/workflow-schema/protob\x06proto3"

var (
	file_fmds_carbide_proto_rawDescOnce sync.Once
	file_fmds_carbide_proto_rawDescData []byte
)

func file_fmds_carbide_proto_rawDescGZIP() []byte {
	file_fmds_carbide_proto_rawDescOnce.Do(func() {
		file_fmds_carbide_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_fmds_carbide_proto_rawDesc), len(file_fmds_carbide_proto_rawDesc)))
	})
	return file_fmds_carbide_proto_rawDescData
}

var file_fmds_carbide_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_fmds_carbide_proto_goTypes = []any{
...
var file_fmds_carbide_proto_depIdxs = []int32{
...
func init() { file_fmds_carbide_proto_init() }
func file_fmds_carbide_proto_init() {
	if File_fmds_carbide_proto != nil {
		return
	}
	file_common_carbide_proto_init()
	file_fmds_carbide_proto_msgTypes[2].OneofWrappers = []any{}
	file_fmds_carbide_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_fmds_carbide_proto_rawDesc), len(file_fmds_carbide_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_fmds_carbide_proto_goTypes,
		DependencyIndexes: file_fmds_carbide_proto_depIdxs,
		MessageInfos:      file_fmds_carbide_proto_msgTypes,
	}.Build()
	File_fmds_carbide_proto = out.File
	file_fmds_carbide_proto_goTypes = nil
	file_fmds_carbide_proto_depIdxs = nil
}
