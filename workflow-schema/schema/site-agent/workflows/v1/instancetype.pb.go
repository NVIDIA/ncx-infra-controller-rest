...
// InstanceTypeInventory - inventory info for all InstanceTypes periodically collected
...
func (x *InstanceTypeInventory) Reset() {
	*x = InstanceTypeInventory{}
	mi := &file_instancetype_proto_msgTypes[0]
...
func (*InstanceTypeInventory) Descriptor() ([]byte, []int) {
	return file_instancetype_proto_rawDescGZIP(), []int{0}
}
...
var File_instancetype_proto protoreflect.FileDescriptor
...
var (
	file_instancetype_proto_rawDescOnce sync.Once
	file_instancetype_proto_rawDescData []byte
)

func file_instancetype_proto_rawDescGZIP() []byte {
	file_instancetype_proto_rawDescOnce.Do(func() {
		file_instancetype_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_instancetype_proto_rawDesc), len(file_instancetype_proto_rawDesc)))
	})
	return file_instancetype_proto_rawDescData
}
...
func init() { file_instancetype_proto_init() }
func file_instancetype_proto_init() {
	if File_instancetype_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_instancetype_proto_rawDesc), len(file_instancetype_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_instancetype_proto_goTypes,
		DependencyIndexes: file_instancetype_proto_depIdxs,
		MessageInfos:      file_instancetype_proto_msgTypes,
	}.Build()
	File_instancetype_proto = out.File
	file_instancetype_proto_goTypes = nil
	file_instancetype_proto_depIdxs = nil
}
